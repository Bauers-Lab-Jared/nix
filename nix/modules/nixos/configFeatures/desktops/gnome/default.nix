...
in {
  ...
  otherOptions = {
      thisFlake.configFeatures.${featureName} = with types; {
        wallpaper = {
          light = mkOpt (oneOf [str package]) pkgs.thisFlake.wallpapers.nord-rainbow-light-nix "The light wallpaper to use.";
          dark = mkOpt (oneOf [str package]) pkgs.thisFlake.wallpapers.solitude "The dark wallpaper to use.";
        };
      ...
      in
        nested-default-attrs {
          "org/gnome/shell" = {
            ...
            favorite-apps =
              ["org.gnome.Nautilus.desktop" "mullvad-browser.desktop"];
          };
          ...
          "org/gnome/shell/extensions/Logo-menu" = {
            ...
            menu-button-terminal =
              if config.thisFlake.configFeatures.term.enable
              then lib.getExe config.thisFlake.configFeatures.term.pkg
